                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach($fine->offenses as $offence_list)
                                   <tr>
                                        <td>{{$offence_list->id}}</td>
                                        <td>{{$fine->section_of_act}}</td>
                                        <td>{{$offence_list->police->registration_number}}</td>
                                       <td>{{$offence_list->licensedHolder->license_no}}</td>
                                       <td>{{$fine->fine_amount}}</td>
                                        <td>{{$offence_list->fine_issued_date}}</td>
                                        <td>
                                            @if($offence_list->payment_status==2)
                                            <span class="badge badge-pill badge-success">Paid&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                            @elseif ($offence_list->payment_status==1)
