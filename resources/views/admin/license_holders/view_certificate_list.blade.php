                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <div class="widget-content widget-content-area br-6">
                       <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Issue Certificate of Merits</h4>
                                    </div
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$certificate->license_holders->first_name}} &nbsp; {{$certificate->license_holders->last_name}}</td>
                                        <td>{{$certificate->license_holders->license_no}}</td>
                                        <td>{{$certificate->license_holders->total_demerit_points}}</td>
                                        <td>
                                            <a href="{{URL('admin/notification')}}/{{$certificate->license_holders->id}}" class="btn btn-primary">Issue Certificate</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
